...
## V8 Inspector, e.g. Chrome DevTools [​](#v8-inspector-e-g-chrome-devtools)
...
Source: [https://electron-vite.org/guide/debugging](https://electron-vite.org/guide/debugging)