...
### Built-in Config for `main`: [​](#built-in-config-for-main)
...
### Built-in Config for `preload`: [​](#built-in-config-for-preload)
...
### Built-in Config for `renderer`: [​](#built-in-config-for-renderer)
...
## Vite Config Reference [​](#vite-config-reference)
...
Source: [https://electron-vite.org/config/](https://electron-vite.org/config/)