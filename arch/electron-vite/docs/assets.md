...
The asset handling feature in this guide applies to the main process. For static asset handling of the renderer process, refer to Vite's [Static Asset Handling](https://vitejs.dev/guide/assets) guide.
...
## Importing Asset as File Path [​](#importing-asset-as-file-path)
...
### Importing Json File as File Path [​](#importing-json-file-as-file-path)
...
### `app.asar.unpacked` File Path Problem [​](#app-asar-unpacked-file-path-problem)
...
## Importing Native Node Modules [​](#importing-native-node-modules)
...
## Importing WebAssembly [​](#importing-webassembly)
...
In renderer, See Vite's [WebAssembly](https://vitejs.dev/guide/features#webassembly) feature for more details.


---

Source: [https://electron-vite.org/guide/assets](https://electron-vite.org/guide/assets)