...
NOTE
  ...
  * The `--inspect` option allows you to enable V8 inspector on the specified port. An external debugger can connect on this port. See [V8 Inspector](./debugging#v8-inspector-e-g-chrome-devtools) for more details.
...
Source: [https://electron-vite.org/guide/cli](https://electron-vite.org/guide/cli)