...
## What is V8 Bytecode [​](#what-is-v8-bytecode)
...
## Enable Bytecode to Protect Your Electron Source Code [​](#enable-bytecode-to-protect-your-electron-source-code)
...
## `bytecodePlugin` Options [​](#bytecodeplugin-options)
...
### transformArrowFunctions [​](#transformarrowfunctions)
...
## Customizing Protection [​](#customizing-protection)
...
## Limitations of V8 Bytecode [​](#limitations-of-v8-bytecode)
...
### Multi Platform Build on One Architecture [​](#multi-platform-build-on-one-architecture)
...
### Multi Architecture Build on One Platform [​](#multi-architecture-build-on-one-platform)
...
### Impact on code organization and writing? [​](#impact-on-code-organization-and-writing)
...
### Does it affect application performance? [​](#does-it-affect-application-performance)

There is no impact on code execution performance and a slight improvement.

### Impact on program volume? [​](#impact-on-program-volume)
...
### How strong is the code protection? [​](#how-strong-is-the-code-protection)
...
Source: [https://electron-vite.org/guide/source-code-protection](https://electron-vite.org/guide/source-code-protection)