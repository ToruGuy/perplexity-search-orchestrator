...
It is recommended to go through [Vite's Env Variables and Modes](https://vitejs.dev/guide/env-and-mode) documentation first before reading the sections below.
...
You can overwrite the default mode used for a command by passing the `--mode` option flag. See [Vite Modes](https://vitejs.dev/guide/env-and-mode#modes).


---

Source: [https://electron-vite.org/guide/env-and-mode](https://electron-vite.org/guide/env-and-mode)