...
## [The Road to Stable and Beyond](#the-road-to-stable-and-beyond)

[Section titled “The Road to Stable and Beyond”](#the-road-to-stable-and-beyond)
...
### [Development Server for Mobile](#development-server-for-mobile)

[Section titled “Development Server for Mobile”](#development-server-for-mobile)

We introduced changes to the network exposure of the built-in development server [PR #10437](https://github.com/tauri-apps/tauri/pull/10437) and [PR #10456](https://github.com/tauri-apps/tauri/pull/10456). With the changes shipped in the 2.0.0-rc.0 release of the Tauri CLI, we can connect to your development server running on localhost when targetting Android and iOS (previously this was only possible when developing a desktop application).

This means you no longer need to expose your development server on the public network.

### [Rust API Surface Refactor](#rust-api-surface-refactor)

[Section titled “Rust API Surface Refactor”](#rust-api-surface-refactor)
...
[Section titled “Too Long Didn’t Read”](#too-long-didnt-read)
...
**Source:** [https://v2.tauri.app/blog/tauri-2-0-0-release-candidate](https://v2.tauri.app/blog/tauri-2-0-0-release-candidate)