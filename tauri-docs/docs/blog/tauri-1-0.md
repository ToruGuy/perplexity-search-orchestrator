...
![Daniel Thompson-Yvetot](/authors/nothingismagick.jpeg)

Daniel Thompson-Yvetot

Tauri Co-Founder

![Tauri 1.0 Launch Hero Image](/_astro/header.SZy5df-y_Ib0t4.webp)
...
## [Tauri Philosophy](#tauri-philosophy)

[Section titled “Tauri Philosophy”](#tauri-philosophy)
...
![Printed sweatshirt](/_astro/hoodie.DdQJVyfM_XFq5q.webp)
...
![Johannes Schickling at Worker Conf 2022 \(photo by @TejasKumar\)](/_astro/worker_conf_2022.DqZoGQMv_142iht.webp)

_Johannes Schickling at Worker Conf 2022 (photo by{' '}[@TejasKumar via Twitter](https://twitter.com/TejasKumar_)) _
...
[Section titled “Accolades”](#accolades)

Here are some of the things people are saying about Tauri:

![Spacedrive Logo](/_astro/spacedrive_logo_dark.Cwbg3dNX_ZkcWB4.webp)

_“Spacedrive had to feel native across all platforms, all while being lightweight, instant to launch and extremely fast to use. This just wasn’t possible with a web-based UI — until now, thanks to Tauri.”_ **\- Jamie Pine** , [Spacedrive](https://www.spacedrive.com) Founder

  


![Prism Logo](/_astro/prisma_logo_dark.Q531EDvP_ZkdpTX.svg)
...
![OSSC Logo](/_astro/ossc_logo_dark.KQs7jVgQ_1COlkl.webp)
...
![Padloc Logo](/_astro/padloc_logo_dark.Cog2jIIZ_2hvcWW.svg)
...
![github](/_astro/github_stars_dark.B0svAuR4_Z12r2fQ.webp)

People love to discuss what is great and terrible about Tauri on orange websites:

![hackernews](/_astro/hackernews.DrH6pFa9_Z1NkFF5.webp)
...
![State of JS 2021](/_astro/state_of_js.CUbKrVoG_Z2kfMar.webp)

Engineers at big companies seem to be eying up Tauri for future projects.

![hackernews](/_astro/ossinsight.CQ4bfSEZ_13hbWj.webp)
...
**Source:** [https://v2.tauri.app/blog/tauri-1-0](https://v2.tauri.app/blog/tauri-1-0)