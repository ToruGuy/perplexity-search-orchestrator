...
![Tillmann Weidinger](/authors/tweidinger.png)
...
[Section titled “What is Tauri?”](#what-is-tauri)
...
![a graph showing the IPC bridge between the Application Core and the System's WebView](/_astro/tauri-trust-boundaries.C0cC9LAT_ZQ2YYs.svg)

### [When Should I Use Tauri?](#when-should-i-use-tauri)

[Section titled “When Should I Use Tauri?”](#when-should-i-use-tauri)
...
## [How Popular is Tauri?](#how-popular-is-tauri)

[Section titled “How Popular is Tauri?”](#how-popular-is-tauri)

![a graph showing the progression of Tauri GitHub stars over the years, starting with 0 at 2019 and continuing to grow past 80.000 in 2024](/_astro/tauri-star-history.Dr3CGlN3_Z2bQ1MF.webp)

On GitHub the Tauri repository has [~4,878 Pull Requests](https://github.com/tauri-apps/tauri/pulls?q=is%3Apr+is%3Aclosed) and [~3,570 Issues](https://github.com/tauri-apps/tauri/issues?q=is%3Aissue+is%3Aclosed) closed and around [1000 discussions](https://github.com/tauri-apps/tauri/discussions), at the time of writing. To get a more detailed insight take a look at [the OSSinsight analysis](https://ossinsight.io/analyze/tauri-apps/tauri) of the Tauri repository.
...
## [How Did We Get to 2.0?](#how-did-we-get-to-20)

[Section titled “How Did We Get to 2.0?”](#how-did-we-get-to-20)
...
## [Who Made This Release Possible?](#who-made-this-release-possible)

[Section titled “Who Made This Release Possible?”](#who-made-this-release-possible)
...
![Lucas' contribution graph, with 2744 commits, over 896.000 additions and 688.000 deletions.](/_astro/lucas-commit-graph.gQ6-XyEM_Z1yPmzc.webp)
...
![CrabNebula Logo](/_astro/crabnebula.xh9nhpEF_2ciaso.svg)
...
## [What Makes 2.0 Great?](#what-makes-20-great)

[Section titled “What Makes 2.0 Great?”](#what-makes-20-great)
...
[Section titled “Getting Started Experience”](#getting-started-experience)
...
For this we created another project, which is called [`create-tauri-app`](https://github.com/tauri-apps/create-tauri-app) or in short CTA. This tool allows developers to start from scratch and get to a running Tauri app in a few minutes instead of hours.

  * [ Bash ](#tab-panel-644)
  * [ PowerShell ](#tab-panel-645)
  * [ Fish ](#tab-panel-646)
  * [ npm ](#tab-panel-647)
  * [ Yarn ](#tab-panel-648)
  * [ pnpm ](#tab-panel-649)
...
[Section titled “Hot-Module Replacement”](#hot-module-replacement)
...
### [The Allowlist is Dead, Long Live the Allowlist](#the-allowlist-is-dead-long-live-the-allowlist)

[Section titled “The Allowlist is Dead, Long Live the Allowlist”](#the-allowlist-is-dead-long-live-the-allowlist)
...
### [External Security Audit](#external-security-audit)

[Section titled “External Security Audit”](#external-security-audit)
...
### [Inter Process Communication (IPC) Rewrite](#inter-process-communication-ipc-rewrite)

[Section titled “Inter Process Communication (IPC) Rewrite”](#inter-process-communication-ipc-rewrite)
...
[Section titled “Distribution Guides”](#distribution-guides)
...
[Section titled “Config restructure”](#config-restructure)
...
[Section titled “Call To Action”](#call-to-action)
...
**Source:** [https://v2.tauri.app/blog/tauri-20](https://v2.tauri.app/blog/tauri-20)