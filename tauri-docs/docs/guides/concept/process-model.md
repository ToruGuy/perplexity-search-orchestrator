...
We chose Rust to implement Tauri because of its concept of [Ownership](https://doc.rust-lang.org/book/ch04-01-what-is-ownership.html) guarantees memory safety while retaining excellent performance.

![Diagram](/d2/docs/concept/process-model-0.svg) Simplified representation of the Tauri process model. A single Core process manages one or more WebView processes.
...
[Section titled “Footnotes”](#footnote-label)
  ...
  1. Currently, Tauri uses [Microsoft Edge WebView2](https://docs.microsoft.com/en-us/microsoft-edge/webview2/) on Windows, [WKWebView](https://developer.apple.com/documentation/webkit/wkwebview) on macOS and [webkitgtk](https://webkitgtk.org) on Linux. [↩](#user-content-fnref-1)
...
**Source:** [https://v2.tauri.app/concept/process-model](https://v2.tauri.app/concept/process-model)