...
## [Multimedia support via GStreamer](#multimedia-support-via-gstreamer)

[Section titled “Multimedia support via GStreamer”](#multimedia-support-via-gstreamer)
...
## [AppImages for ARM-based devices](#appimages-for-arm-based-devices)

[Section titled “AppImages for ARM-based devices”](#appimages-for-arm-based-devices)

`linuxdeploy`, the AppImage tooling Tauri uses, currently [does not support cross-compiling](https://github.com/linuxdeploy/linuxdeploy/issues/258) ARM AppImages. This means ARM AppImages can only be built on ARM devices or emulators.
...
**Source:** [https://v2.tauri.app/distribute/appimage](https://v2.tauri.app/distribute/appimage)