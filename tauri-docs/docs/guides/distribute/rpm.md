...
## [Configuring the RPM package](#configuring-the-rpm-package)

[Section titled “Configuring the RPM package”](#configuring-the-rpm-package)

Tauri allows you to configure the RPM package by adding scripts, setting dependencies, adding a license, including custom files, and more. For detailed information about configurable options, please refer to: [RpmConfig](https://v2.tauri.app/reference/config/#rpmconfig).

### [Add post, pre-install/remove script to the package](#add-post-pre-installremove-script-to-the-package)

[Section titled “Add post, pre-install/remove script to the package”](#add-post-pre-installremove-script-to-the-package)
...
### [Setting the Conflict, Provides, Depends, Files, Obsoletes, DesktopTemplate, and Epoch](#setting-the-conflict-provides-depends-files-obsoletes-desktoptemplate-and-epoch)

[Section titled “Setting the Conflict, Provides, Depends, Files, Obsoletes, DesktopTemplate, and Epoch”](#setting-the-conflict-provides-depends-files-obsoletes-desktoptemplate-and-epoch)
...
### [Add a license to the package](#add-a-license-to-the-package)

[Section titled “Add a license to the package”](#add-a-license-to-the-package)
...
[Section titled “Building the RPM package”](#building-the-rpm-package)
...
## [Signing the RPM package](#signing-the-rpm-package)

[Section titled “Signing the RPM package”](#signing-the-rpm-package)
...
[Section titled “Generate a GPG key”](#generate-a-gpg-key)
...
## [Debugging the RPM package](#debugging-the-rpm-package)

[Section titled “Debugging the RPM package”](#debugging-the-rpm-package)
...
### [Getting information about the package](#getting-information-about-the-package)

[Section titled “Getting information about the package”](#getting-information-about-the-package)
...
### [Query specific information about the package](#query-specific-information-about-the-package)

[Section titled “Query specific information about the package”](#query-specific-information-about-the-package)
...
### [Checking the content of the package](#checking-the-content-of-the-package)

[Section titled “Checking the content of the package”](#checking-the-content-of-the-package)
...
[Section titled “Debugging scripts”](#debugging-scripts)
...
[Section titled “Checking dependencies”](#checking-dependencies)
...
### [List packages that depend on a specific package](#list-packages-that-depend-on-a-specific-package)

[Section titled “List packages that depend on a specific package”](#list-packages-that-depend-on-a-specific-package)
...
[Section titled “Debugging Installation Issues”](#debugging-installation-issues)
...
**Source:** [https://v2.tauri.app/distribute/rpm](https://v2.tauri.app/distribute/rpm)