...
## [Preparing for Mobile](#preparing-for-mobile)

[Section titled “Preparing for Mobile”](#preparing-for-mobile)
...
[Section titled “Summary of Changes”](#summary-of-changes)
...
### [New Cargo Features](#new-cargo-features)

[Section titled “New Cargo Features”](#new-cargo-features)

  * linux-protocol-body: Enables custom protocol request body parsing, allowing the IPC to use it. Requires webkit2gtk 2.40.


### [Removed Cargo Features](#removed-cargo-features)

[Section titled “Removed Cargo Features”](#removed-cargo-features)
...
### [Rust Crate Changes](#rust-crate-changes)

[Section titled “Rust Crate Changes”](#rust-crate-changes)
...
[Section titled “JavaScript API Changes”](#javascript-api-changes)
...
### [Environment Variables Changes](#environment-variables-changes)

[Section titled “Environment Variables Changes”](#environment-variables-changes)
...
### [Multiwebview support](#multiwebview-support)

[Section titled “Multiwebview support”](#multiwebview-support)
...
### [New origin URL on Windows](#new-origin-url-on-windows)

[Section titled “New origin URL on Windows”](#new-origin-url-on-windows)
...
[Section titled “Detailed Migration Steps”](#detailed-migration-steps)

Common scenarios you may encounter when migrating your Tauri 1.0 app to Tauri 2.0.

### [Migrate to Core Module](#migrate-to-core-module)

[Section titled “Migrate to Core Module”](#migrate-to-core-module)
...
### [Migrate to CLI Plugin](#migrate-to-cli-plugin)

[Section titled “Migrate to CLI Plugin”](#migrate-to-cli-plugin)
...
### [Migrate to Clipboard Plugin](#migrate-to-clipboard-plugin)

[Section titled “Migrate to Clipboard Plugin”](#migrate-to-clipboard-plugin)
...
### [Migrate to Dialog Plugin](#migrate-to-dialog-plugin)

[Section titled “Migrate to Dialog Plugin”](#migrate-to-dialog-plugin)
...
### [Migrate to File System Plugin](#migrate-to-file-system-plugin)

[Section titled “Migrate to File System Plugin”](#migrate-to-file-system-plugin)
...
### [Migrate to Global Shortcut Plugin](#migrate-to-global-shortcut-plugin)

[Section titled “Migrate to Global Shortcut Plugin”](#migrate-to-global-shortcut-plugin)
...
### [Migrate to HTTP Plugin](#migrate-to-http-plugin)

[Section titled “Migrate to HTTP Plugin”](#migrate-to-http-plugin)
...
### [Migrate to Notification Plugin](#migrate-to-notification-plugin)

[Section titled “Migrate to Notification Plugin”](#migrate-to-notification-plugin)
...
### [Migrate to Menu Module](#migrate-to-menu-module)

[Section titled “Migrate to Menu Module”](#migrate-to-menu-module)
...
#### [Use `tauri::menu::MenuBuilder`](#use-taurimenumenubuilder)

[Section titled “Use tauri::menu::MenuBuilder”](#use-taurimenumenubuilder)
...
#### [Use `tauri::menu::PredefinedMenuItem`](#use-taurimenupredefinedmenuitem)

[Section titled “Use tauri::menu::PredefinedMenuItem”](#use-taurimenupredefinedmenuitem)
...
#### [Use `tauri::menu::MenuItemBuilder`](#use-taurimenumenuitembuilder)

[Section titled “Use tauri::menu::MenuItemBuilder”](#use-taurimenumenuitembuilder)
...
#### [Use `tauri::menu::SubmenuBuilder`](#use-taurimenusubmenubuilder)

[Section titled “Use tauri::menu::SubmenuBuilder”](#use-taurimenusubmenubuilder)
...
[Section titled “Menu Events”](#menu-events)
...
### [Migrate to OS Plugin](#migrate-to-os-plugin)

[Section titled “Migrate to OS Plugin”](#migrate-to-os-plugin)
...
### [Migrate to Process Plugin](#migrate-to-process-plugin)

[Section titled “Migrate to Process Plugin”](#migrate-to-process-plugin)
...
### [Migrate to Shell Plugin](#migrate-to-shell-plugin)

[Section titled “Migrate to Shell Plugin”](#migrate-to-shell-plugin)
...
### [Migrate to Tray Icon Module](#migrate-to-tray-icon-module)

[Section titled “Migrate to Tray Icon Module”](#migrate-to-tray-icon-module)

The Rust `SystemTray` APIs were renamed to `TrayIcon` for consistency. The new APIs can be found in the Rust `tray` module.

#### [Use `tauri::tray::TrayIconBuilder`](#use-tauritraytrayiconbuilder)

[Section titled “Use tauri::tray::TrayIconBuilder”](#use-tauritraytrayiconbuilder)
...
#### [Migrate to Menu](#migrate-to-menu)

[Section titled “Migrate to Menu”](#migrate-to-menu)
...
#### [Tray Events](#tray-events)

[Section titled “Tray Events”](#tray-events)
...
### [Migrate to Updater Plugin](#migrate-to-updater-plugin)

[Section titled “Migrate to Updater Plugin”](#migrate-to-updater-plugin)
...
### [Migrate Path to Tauri Manager](#migrate-path-to-tauri-manager)

[Section titled “Migrate Path to Tauri Manager”](#migrate-path-to-tauri-manager)
...
### [Migrate to new Window API](#migrate-to-new-window-api)

[Section titled “Migrate to new Window API”](#migrate-to-new-window-api)
...
### [Migrate Embedded Additional Files (Resources)](#migrate-embedded-additional-files-resources)

[Section titled “Migrate Embedded Additional Files (Resources)”](#migrate-embedded-additional-files-resources)

On the JavaScript side, make sure you [Migrate to File System Plugin](#migrate-to-file-system-plugin). Additionally, note the changes made to the v1 allowlist in [Migrate Permissions](#migrate-permissions).

On the Rust side, make sure you [Migrate Path to Tauri Manager](#migrate-path-to-tauri-manager).

### [Migrate Embedded External Binaries (Sidecar)](#migrate-embedded-external-binaries-sidecar)

[Section titled “Migrate Embedded External Binaries (Sidecar)”](#migrate-embedded-external-binaries-sidecar)
...
[Section titled “Migrate Permissions”](#migrate-permissions)
...
**Source:** [https://v2.tauri.app/start/migrate/from-tauri-1](https://v2.tauri.app/start/migrate/from-tauri-1)