...
To grant or deny a permission to your app’s window or webview, you must reference the permission in a [capability](/security/capabilities/).
...
[Section titled “Permission Identifier”](#permission-identifier)
...
**Source:** [https://v2.tauri.app/security/permissions](https://v2.tauri.app/security/permissions)