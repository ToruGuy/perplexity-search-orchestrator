...
[Section titled “Steps”](#steps)
  ...
  1. ##### [Install dependencies and run the project](#install-dependencies-and-run-the-project)
...
Show solution
[code] # Make sure you're in the right directory
...
![Successful run of the created template app.](/_astro/step_1._Ugp-O91_ZSMRXB.webp)

  2. ##### [Register new windows in `tauri.conf.json`](#register-new-windows-in-tauriconfjson)
...
[/code]
  ...
  3. ##### [Create a new page to host your splashscreen](#create-a-new-page-to-host-your-splashscreen)
...
![The splashscreen we just created.](/_astro/step_3.Cjc3aTae_Z1lYXqD.webp)

  4. ##### [Start some setup tasks](#start-some-setup-tasks)
...
Show solution
[code] # Run this command where the `Cargo.toml` file is
...
src/main.ts
[code]// These contents can be copy-pasted below the existing code, don't replace the entire file!!
...
[code]// Import functionalities we'll be using
...
##### [Should you have a splashscreen?](#should-you-have-a-splashscreen)
...
**Source:** [https://v2.tauri.app/learn/splashscreen](https://v2.tauri.app/learn/splashscreen)