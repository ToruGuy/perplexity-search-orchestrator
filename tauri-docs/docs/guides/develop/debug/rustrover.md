...
## [Setting up a Cargo project](#setting-up-a-cargo-project)

[Section titled “Setting up a Cargo project”](#setting-up-a-cargo-project)
...
## [Setting up Run Configurations](#setting-up-run-configurations)

[Section titled “Setting up Run Configurations”](#setting-up-run-configurations)
...
[Section titled “Tauri App”](#tauri-app)
...
![Add Run/Debug Configuration](/_astro/add-cargo-config-light.Bfob59bJ_3843j.webp)
...
![Add --no-default-features flag](/_astro/set-no-default-features-light.CcoA2Q8U_ZERf6f.webp)
...
![Rename Configuration](/_astro/rename-configuration-light.B4TFjRby_14ggqy.webp)
...
![NPM Configuration](/_astro/npm-configuration-light.B2Rk0eaZ_1nVTkM.webp)
...
![Trunk Serve Configuration](/_astro/trunk-configuration-light.78simsDr_Z1kReY3.webp)

## [Launching a Debugging Session](#launching-a-debugging-session)

[Section titled “Launching a Debugging Session”](#launching-a-debugging-session)
...
![Debug Session](/_astro/debug-session-light.BcVudV4z_11xeNd.webp)
...
**Source:** [https://v2.tauri.app/develop/debug/rustrover](https://v2.tauri.app/develop/debug/rustrover)