...
## [Initialize Plugin Project](#initialize-plugin-project)

[Section titled “Initialize Plugin Project”](#initialize-plugin-project)
...
[Section titled “Mobile Plugin Development”](#mobile-plugin-development)
...
[Section titled “on_navigation”](#on_navigation)
...
[Section titled “on_webview_ready”](#on_webview_ready)
...
[Section titled “on_event”](#on_event)
...
[Section titled “on_drop”](#on_drop)
...
## [Exposing Rust APIs](#exposing-rust-apis)

[Section titled “Exposing Rust APIs”](#exposing-rust-apis)
...
[Section titled “Adding Commands”](#adding-commands)
...
[Section titled “Command Permissions”](#command-permissions)
...
[Section titled “Permission Files”](#permission-files)
...
Your plugin consumer can define a scope for a specific command in their capability file (see the [documentation](/reference/acl/scope/)). You can read the command-specific scope with the [`tauri::ipc::CommandScope`](https://docs.rs/tauri/2.0.0/tauri/ipc/struct.CommandScope.html) struct:
...
[Section titled “Global Scope”](#global-scope)
...
[Section titled “Permission Sets”](#permission-sets)
...
[Section titled “Autogenerated Permissions”](#autogenerated-permissions)
...
[Section titled “Managing State”](#managing-state)
...
**Source:** [https://v2.tauri.app/develop/plugins](https://v2.tauri.app/develop/plugins)