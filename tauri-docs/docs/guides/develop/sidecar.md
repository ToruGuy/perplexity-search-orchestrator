...
## [Running it from Rust](#running-it-from-rust)

[Section titled “Running it from Rust”](#running-it-from-rust)
...
## [Running it from JavaScript](#running-it-from-javascript)

[Section titled “Running it from JavaScript”](#running-it-from-javascript)
...
You can pass arguments to Sidecar commands just like you would for running normal [Command](https://doc.rust-lang.org/std/process/struct.Command.html).
...
**Source:** [https://v2.tauri.app/develop/sidecar](https://v2.tauri.app/develop/sidecar)