...
It is possible to run [WebDriver](https://www.w3.org/TR/webdriver/) tests with [`tauri-driver`](https://crates.io/crates/tauri-driver) on your CI. The following example uses the [WebdriverIO](https://webdriver.io/) example we [previously built together](/develop/tests/webdriver/example/webdriverio/) and GitHub Actions.
...
The following GitHub Actions assumes:
  ...
  2. The [WebDriverIO](https://webdriver.io/) test runner is in the `e2e-tests` directory and runs when `yarn test` is used in that directory.
...
**Source:** [https://v2.tauri.app/develop/tests/webdriver/ci](https://v2.tauri.app/develop/tests/webdriver/ci)