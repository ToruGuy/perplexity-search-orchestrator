...
[ GitHub](https://github.com/tauri-apps/plugins-workspace/tree/v2/plugins/store) [ npm ](https://www.npmjs.com/package/@tauri-apps/plugin-store) [ crates.io ](https://crates.io/crates/tauri-plugin-store)

API Reference [ ](/reference/javascript/store/) [ ](https://docs.rs/tauri-plugin-store)
...
Install the store plugin to get started.
  ...
  * [ Automatic ](#tab-panel-1477)
  * [ Manual ](#tab-panel-1478)
...
[code] cargo add tauri-plugin-store
[/code]
...
[/code]
  ...
  3. Install the JavaScript Guest bindings using your preferred JavaScript package manager:
     ...
     * [ deno ](#tab-panel-1475)
     * [ bun ](#tab-panel-1476)
[code] npm install @tauri-apps/plugin-store
[/code]
[code] yarn add @tauri-apps/plugin-store
[/code]
[code] pnpm add @tauri-apps/plugin-store
[/code]
[code] deno add npm:@tauri-apps/plugin-store
[/code]
[code] bun add @tauri-apps/plugin-store
[/code]
...
## [Migrating from v1 and v2 beta/rc](#migrating-from-v1-and-v2-betarc)
...
**Source:** [https://v2.tauri.app/plugin/store](https://v2.tauri.app/plugin/store)